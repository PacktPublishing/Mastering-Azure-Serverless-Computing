...
namespace OrderManager.Functions.Extensions
{
    public static class CloudTableExtensions
    {
        ...
        public static async Task<bool> InsertEntityAsync(this CloudTable table, TableEntity entity)
        {
        ...
        public static async Task<bool> UpdateEntityAsync(this CloudTable table, TableEntity entity)
        {
        ...
        public static async Task<bool> InsertOrReplaceEntityAsync(this CloudTable table, TableEntity entity)
        {
